            ...
            !(function (e) {
                ...
                function s(t) {
                    void 0 === t.imagePlaceholder
                        ...
                        : (w.impl.options.imagePlaceholder =
                              t.imagePlaceholder),
                        void 0 === t.cacheBust
                            ...
                            return (
                                ...
                                new Promise(function (n) {
                                    ...
                                    if (w.impl.options.imagePlaceholder) {
                                        var l =
                                            w.impl.options.imagePlaceholder.split(
                                                /,/
                                            );
                                        l && l[1] && (s = l[1]);
                                    }
                    ...
                    p = (function () {
                        ...
                        function e() {
                            ...
                            return Promise.resolve(
                                h.asArray(document.styleSheets)
                            )
                                .then(e)
                                .then(t)
                                .then(function (t) {
    ...
    (L.Control.EasyPrint = L.Control.extend({
        ...
        onAdd: function () {
            (this.mapContainer = this._map.getContainer()),
                (this.options.sizeModes = this.options.sizeModes.map(function (
                    t
                ) {
                    return "Current" === t
                        ? {
        ...
        printMap: function (t, e) {
            ...
            (this.outerContainer = this._createOuterContainer(
                ...
                this.originalState.widthWasAuto &&
                    (this.outerContainer.style.width =
                        this.originalState.mapWidth),
        ...
        _createImagePlaceholder: function (t) {
            ...
            n.toPng(this.mapContainer, {
                ...
                .then(function (n) {
                    ...
                    var i = e.blankDiv;
                    e.outerContainer.parentElement.insertBefore(
                        i,
                        e.outerContainer
                    ),
        ...
        _printOpertion: function (t) {
            ...
            ((this.originalState.widthWasAuto && "CurrentSize" === t) ||
                (this.originalState.widthWasPercentage &&
                    "CurrentSize" === t)) &&
                ...
                n
                    .toPng(e.mapContainer, {
                        width: parseInt(o),
                        height: parseInt(
                            e.mapContainer.style.height.replace("px")
                        ),
                    })
                    .then(function (t) {
                        ...
                        e.options.exportOnly
                            ...
                            e.outerContainer &&
                                (e.originalState.widthWasAuto
                                    ...
                                    : (e.mapContainer.style.width =
                                          e.originalState.mapWidth),
                                (e.mapContainer.style.height =
                                    e.originalState.mapHeight),
